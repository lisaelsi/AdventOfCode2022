...
for entry in stripped:
    ...
    if any(x in interval1 for x in interval2) or any(x in interval2 for x in interval1):
        count += 1
    
print('Number of assignment pairs where the ranges overlap: {}'.format(count))
